...
| [OpenClaw Job Finding Agent](./clawedin-openclawjobfindagent/) | clawedin | AI-powered job matching agent that parses a candidate's CV and uses HrFlow.ai APIs to search, score, and rank the most relevant job opportunities, orchestrated by OpenClaw with a local LLM. |
| [404-Job-Not-Found](./EdouardAndre-404-job-not-found/) | 404-Job-Not-Found | An HRFlow hackathon app that fetches a candidate profile and a job, runs a 5-question AI interview, and produces a final report with both interview scoring and HRFlow profile-job matching. |
